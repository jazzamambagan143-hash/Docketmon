              ...
              <tr class="cases-row" data-id="${c.id}" style="cursor:pointer;">
                ...
                <td>
                  ...
                  <div class="text-xs text-muted">
                     <b>${p1Label}:</b> <div style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">${p1Names}</div>
                     <b>${p2Label}:</b> <div style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">${p2Names}</div>
                  </div>
                </td>
                <td>
      ...
      <div class="modal-overlay active">
        <div class="modal-content glow-panel" style="max-width: 600px; border: 2px solid #000; background:#fff; box-shadow: 0 0 40px rgba(0,0,0,0.5);">
          <div class="modal-header" style="border-bottom: 2px solid #000; background: #f0f0f0;">
            <h3 style="color:#000; font-family:'Outfit'; font-weight:800;">CASE SUMMARY: ${caseRecord.caseNo}</h3>
